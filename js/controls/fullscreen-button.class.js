...
class FullscreenManager {
    ...
    addTouchListeners() {
        ...
        this.fullscreenButton.addEventListener('touchstart', (e) => {
            e.preventDefault();
            e.stopPropagation();
            this.fullscreenButton.classList.add('pressed');
        });

        this.fullscreenButton.addEventListener('touchend', (e) => {
            e.preventDefault();
            e.stopPropagation();
            this.fullscreenButton.classList.remove('pressed');
            this.toggleFullscreen();
        });

        this.fullscreenButton.addEventListener('touchcancel', (e) => {
            e.preventDefault();
            e.stopPropagation();
            this.fullscreenButton.classList.remove('pressed');
        });
        ...
        this.fullscreenButton.addEventListener('mouseleave', (e) => {
            this.fullscreenButton.classList.remove('pressed');
        });
    }
